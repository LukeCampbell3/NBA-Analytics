module github.com/jcthi/nba-analytics/paywall-function-payment-webhook

go 1.25.0

require github.com/jcthi/nba-analytics/paywall v0.0.0
...
replace github.com/jcthi/nba-analytics/paywall => ../../../lib

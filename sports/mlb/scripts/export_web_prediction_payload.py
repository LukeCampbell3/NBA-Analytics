        ...
        plays.append(
            {
                ...
                "opposing_pitcher_id": to_int(row.get("Opposing_Pitcher_ID")),
                "opposing_pitcher": row.get("Opposing_Pitcher", ""),
                "matchup_network_version": row.get("Matchup_Network_Version", ""),
                "batter_profile_strength": to_float(row.get("Batter_Profile_Strength")),
                "pitcher_profile_vulnerability": to_float(row.get("Pitcher_Profile_Vulnerability")),

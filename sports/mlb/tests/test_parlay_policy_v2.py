...
Ported from sports/nba/tests/test_parlay_policy_v2.py -- same mechanism,
same tests, MLB-native dotted imports. These tests verify the *mechanism*
-- gate ordering, penalty math, and leakage-safety of the rolling regime
gate -- against synthetic fixtures. See real-data assertions in
test_parlay_policy_v2_real_data_backtest.py and
sports/mlb/research/parlay_policy_v2/REPORT.md for what real, settled MLB
data does and doesn't establish about this mechanism.
"""

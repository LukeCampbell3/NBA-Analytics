...
def main() -> None:
    ...
    def _compute_final_board_for_policy(active_policy: dict) -> pd.DataFrame:
        return compute_final_board(
            ...
            target_direction_allocation_enabled=bool(active_policy.get("target_direction_allocation_enabled", False)),
            target_direction_min_rows=int(active_policy.get("target_direction_min_rows", 80)),
            target_direction_strong_rate=float(active_policy.get("target_direction_strong_rate", 0.64)),
            target_direction_weak_rate=float(active_policy.get("target_direction_weak_rate", 0.56)),
            target_direction_very_weak_rate=float(active_policy.get("target_direction_very_weak_rate", 0.52)),
            target_direction_max_weak_cap=int(active_policy.get("target_direction_max_weak_cap", 1)),
            target_direction_max_very_weak_cap=int(active_policy.get("target_direction_max_very_weak_cap", 0)),
            target_direction_weak_penalty_weight=float(active_policy.get("target_direction_weak_penalty_weight", 0.035)),
            target_direction_recent_weakness_penalty_weight=float(active_policy.get("target_direction_recent_weakness_penalty_weight", 0.030)),
            target_direction_reserve_max_slots=int(active_policy.get("target_direction_reserve_max_slots", 2)),
            target_direction_reserve_min_prob=float(active_policy.get("target_direction_reserve_min_prob", 0.54)),

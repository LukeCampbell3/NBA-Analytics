    ...
    for _, row in slate_df.iterrows():
        ...
        for target in TARGETS:
            ...
            row_payload = {
                ...
                "event_time_resolution_reason": row.get("event_time_resolution_reason"),
                "event_time_resolution_warning": row.get("event_time_resolution_warning"),
                ...
                "explicit_prelock_run_flag": bool(row.get("explicit_prelock_run_flag", False)),
